...
const RACES = [
  { raceCode: 'tour-thailand-2026', slug: 'tour-of-thailand', type: 'multi', stages: 6 },
  { raceCode: 'dwars-vlaanderen-2026', slug: 'dwars-door-vlaanderen', type: 'single' },
  { raceCode: 'dwars-vlaanderen-women-2026', slug: 'dwars-door-vlaanderen-women', type: 'single' },
  { raceCode: 'gp-indurain-2026', slug: 'gp-miguel-indurain', type: 'single' },
  { raceCode: 'volta-limburg-2026', slug: 'volta-nxt-classic', type: 'single' },
  { raceCode: 'ronde-vlaanderen-2026', slug: 'ronde-van-vlaanderen', type: 'single' },
  { raceCode: 'ronde-vlaanderen-women-2026', slug: 'ronde-van-vlaanderen-women', type: 'single' },
  { raceCode: 'itzulia-2026', slug: 'itzulia-basque-country', type: 'multi', stages: 6 },
  { raceCode: 'pays-loire-2026', slug: 'region-pays-de-la-loire-tour', type: 'multi', stages: 4 },
  { raceCode: 'scheldeprijs-2026', slug: 'scheldeprijs', type: 'single' },
  { raceCode: 'scheldeprijs-women-2026', slug: 'scheldeprijs-vrouwen-elite', type: 'single' },
  { raceCode: 'paris-roubaix-2026', slug: 'paris-roubaix', type: 'single' },
  { raceCode: 'paris-roubaix-women-2026', slug: 'paris-roubaix-femmes', type: 'single' },
  { raceCode: 'paris-camembert-2026', slug: 'paris-camembert', type: 'single' },
  { raceCode: 'tour-hainan-2026', slug: 'tour-of-hainan', type: 'multi', stages: 5 },
  { raceCode: 'brabantse-pijl-women-2026', slug: 'brabantse-pijl-women', type: 'single' },
  { raceCode: 'brabantse-pijl-2026', slug: 'brabantse-pijl', type: 'single' },
  { raceCode: 'amstel-gold-2026', slug: 'amstel-gold-race', type: 'single' },
  { raceCode: 'amstel-gold-women-2026', slug: 'amstel-gold-race-ladies-edition', type: 'single' },
  { raceCode: 'roue-tourangelle-2026', slug: 'la-roue-tourangelle', type: 'single' },
  { raceCode: 'tour-alps-2026', slug: 'tour-of-the-alps', type: 'multi', stages: 5 },
  { raceCode: 'fleche-wallonne-2026', slug: 'la-fleche-wallonne', type: 'single' },
  { raceCode: 'fleche-wallonne-women-2026', slug: 'la-fleche-wallonne-feminine', type: 'single' },
  { raceCode: 'liege-bastogne-2026', slug: 'liege-bastogne-liege', type: 'single' },
  { raceCode: 'liege-bastogne-women-2026', slug: 'liege-bastogne-liege-femmes', type: 'single' }
];
...
async function fetchStages(config) {
  const urls = config.type === 'single'
    ? [`https://www.domestiquecycling.com/en/cycling-races/${config.slug}/2026/race/`]
    : Array.from({ length: config.stages }, (_, i) => `https://www.domestiquecycling.com/en/cycling-races/${config.slug}/2026/stage-${i + 1}/`);
