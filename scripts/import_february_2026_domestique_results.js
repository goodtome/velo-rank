...
const RACES = [
  { raceCode: 'cadel-evans-2026', slug: 'cadel-evans-road-race', type: 'single' },
  { raceCode: 'etoile-besseges-2026', slug: 'etoile-de-besseges', type: 'multi', stages: 5 },
  { raceCode: 'volta-valenciana-2026', slug: 'volta-comunitat-valenciana', type: 'multi', stages: 5 },
  { raceCode: 'uae-tour-women-2026', slug: 'uae-tour-women', type: 'multi', stages: 4 },
  { raceCode: 'muscat-classic-2026', slug: 'muscat-classic', type: 'single' },
  { raceCode: 'tour-oman-2026', slug: 'tour-of-oman', type: 'multi', stages: 5 },
  { raceCode: 'vuelta-cv-feminas-2026', slug: 'vuelta-cv-feminas', type: 'single' },
  { raceCode: 'setmana-valenciana-2026', slug: 'setmana-ciclista-valenciana', type: 'multi', stages: 4 },
  { raceCode: 'tour-provence-2026', slug: 'tour-de-la-provence', type: 'multi', stages: 3 },
  { raceCode: 'figueira-2026', slug: 'figueira-champions-classic', type: 'single' },
  { raceCode: 'clasica-almeria-2026', slug: 'clasica-de-almeria', type: 'single' },
  { raceCode: 'clasica-almeria-men-2026', slug: 'clasica-de-almeria', type: 'single' },
  { raceCode: 'uae-tour-2026', slug: 'uae-tour', type: 'multi', stages: 7 },
  { raceCode: 'volta-algarve-2026', slug: 'volta-ao-algarve', type: 'multi', stages: 5 },
  { raceCode: 'vuelta-andalucia-2026', slug: 'vuelta-a-andalucia', type: 'multi', stages: 5 },
  {
    raceCode: 'tour-haut-var-2026',
    type: 'custom',
    pages: [
      { slug: 'classic-var', kind: 'race', stageNumber: 1 },
      { slug: 'tour-des-alpes-maritimes', kind: 'race', stageNumber: 2 }
    ]
  },
  { raceCode: 'clasica-almeria-women-2026', slug: 'clasica-de-almeria-women', type: 'single' },
  { raceCode: 'faun-ardeche-2026', slug: 'faun-ardeche-classic', type: 'single' },
  { raceCode: 'omloop-2026', slug: 'omloop-nieuwsblad', type: 'single' },
  { raceCode: 'omloop-women-2026', slug: 'omloop-nieuwsblad-women', type: 'single' }
];
...
async function fetchStagePage(page) {
  ...
  if (page.stageNumber) stage.stageNumber = page.stageNumber;
  return stage;
}
