...
const RACES = [
  { raceCode: 'eschborn-frankfurt-2026', slug: 'eschborn-frankfurt', type: 'single' },
  { raceCode: 'tour-finistere-2026', slug: 'tour-du-finistere', type: 'single' },
  { raceCode: 'boucles-aulne-2026', slug: 'boucles-de-laulne', type: 'single' },
  { raceCode: 'vuelta-femenina-2026', slug: 'vuelta-espana-femenina', type: 'multi', stages: 7 },
  { raceCode: 'gp-morbihan-2026', slug: 'gp-de-plumelec-morbihan', type: 'single' },
  { raceCode: 'tro-bro-leon-2026', slug: 'tro-bro-leon', type: 'single' },
  { raceCode: 'clasica-navarra-women-2026', slug: 'navarra-elite-classics', type: 'single' },
  { raceCode: 'itzulia-women-2026', slug: 'itzulia-women', type: 'multi', stages: 3 },
  { raceCode: 'classique-dunkerque-2026', slug: 'classique-dunkerque', type: 'single' },
  { raceCode: 'vuelta-burgos-women-2026', slug: 'vuelta-a-burgos-feminas', type: 'multi', stages: 4 },
  { raceCode: 'antwerp-port-epic-women-2026', slug: 'antwerp-port-epic-ladies', type: 'single' },
  { raceCode: 'tour-kumano-2026', slug: 'tour-de-kumano', type: 'multi', stages: 4 }
];
...
async function importRace(conn, config) {
  ...
  return { raceCode: config.raceCode, stages: summary, finalGcRows: gcRows.length };
}
