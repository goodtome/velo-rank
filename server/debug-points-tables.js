...
async function main() {
  let browser;
  try {
    console.log('🔍 调试 /stage-1-points 页面表格结构...\n');
    ...
    console.log('\n✅ 调试完成！');
    console.log('💡 提示：正确的 Points classification 表格应该包含 "Points" 列\n');
    
    // 保存页面 HTML
    const html = await page.content();
    fs.writeFileSync('debug-points-table.html', html);
    console.log('💾 已保存页面 HTML 到 debug-points-table.html');
