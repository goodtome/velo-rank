...
// 第13赛段信息
const STAGE_ID = '48925f65-7809-4d2d-b56b-d0afce170c51';
const STAGE_CODE = 'giro-2026-s13';
const JSON_FILE = 'D:/codes/velo-rank/server/stage13_full.json';

async function importStage13() {
  let conn;
  let inserted = 0;
  let skipped = 0;
